...
![DevSecOps](public/assets/Grafana.png)
...
Git clone https://github.com/swapnilsalsankar/DevSecOps-Netflix-Clone.git
...
3 sudo usermod -aG docker $USER  # Replace with your system's username, e.g., 'ubuntu'

4 newgrp docker

sudo chmod 777 /var/run/docker.sock

5 Build and run your application using Docker containers:
...
**It will show an error because you need API key**
**
